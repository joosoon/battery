...
if __name__ == '__main__':
    ...
    tol_list = [0.00,0.05,0.10,0.15,0.20,0.25]
    datas_keep = {}
    for tolerance in tqdm(tol_list):
        ...
        for i, cell_id in enumerate(tqdm(cell_ids)):
            ...
            for data_type, crates in gts_real.items():
                ...
                # keep results
                if cell_id not in datas_keep:
                    datas_keep[cell_id] = {}
                datas_keep[cell_id][tolerance] = {"select_ratio":select_ratio, "success":success}
    print("---" * 20)
    print("tolerance", end=',')
    ...
    for tolerance in tol_list:
        print(tolerance, end=',')
    print()
    for cell_id, datas in datas_keep.items():
        print(cell_id, end=',')
        for tolerance, data in datas.items():
            print(data['select_ratio'], end=',')
        for tolerance, data in datas.items():
            print(data['success'], end=',')
        print()
    exit()
